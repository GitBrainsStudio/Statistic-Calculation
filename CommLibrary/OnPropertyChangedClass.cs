...
namespace Statistic.CommLibrary
{
    public abstract class OnPropertyChangedClass : INotifyPropertyChanged
    {
        ...
        /// <summary>Метод для вызова события извещения об изменении свойства</summary>
        /// <param name="propertyName">Изменившееся свойство</param>
        /// <param name="value">Дополнительные параметры события</param>
        public void OnPropertyChanged(string propertyName, object value)
            => PropertyChanged?.Invoke(this, new PropertyChangedExtendedEventArgs(propertyName, value));
